...
const Education = () => {
  return (
    <section id="education" className="section scrollspy" data-aos="fade-down" data-aos-delay="175">
      ...
      <Container>
        <CardProduct title="The Hacking Project" description="Developpeur Web " strong="ReactJs / Ruby on Rails" location="Lyon (69)" date="2020-2021" img={Thp} />
        <CardProduct title="3w Academy" description="Developpeur Web " strong="JS / PHP" location="Lyon (69)" date="2019" img={ThreeWa} />
      </Container>
    </section>
  );
};
